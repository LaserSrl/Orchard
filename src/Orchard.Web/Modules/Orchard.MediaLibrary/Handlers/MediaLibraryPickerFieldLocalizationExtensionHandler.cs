        ...
        protected override void UpdateEditorShape(UpdateEditorContext context) {
            ...
            if (context.ContentItem.Parts.Any(part => part is LocalizationPart)) {
                ...
                foreach (var field in fields) {
                    ...
                    var settings = new { TryToLocalizeMedia = true, AutoTranslateUntranslated = true, RemoveItemsWithoutLocalization=true, RemoveItemsWithNoLocalizationPart = true }; //TODO: create a setting for this
                                ...
                                if (contentCulture == mediaCulture) {
                                    ...
                                    if (mediaCulture == null) {
                                        ...
                                        if (localizedMedia != null) {
                                            ...
                                            if (settings.AutoTranslateUntranslated) {
                                                // The media supports translations but have no translation, so it will be cloned in the right language
                                            ...
                                            else if (!settings.RemoveItemsWithoutLocalization) {
                                                mediaIds.Add(mediaItem.Id);
                                            }
                                        }
                                    }
