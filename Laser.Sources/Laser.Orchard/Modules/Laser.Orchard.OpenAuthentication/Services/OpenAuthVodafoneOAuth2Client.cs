...
namespace Laser.Orchard.OpenAuthentication.Services {
    public class OpenAuthVodafoneOAuth2Client : OAuth2Client {
...
//}
    ...
    private const string ScopeBaseUri = "https://www.googleapis.com/auth/";
        ...
        public OpenAuthVodafoneOAuth2Client(string clientId, string clientSecret)
        ...
        public OpenAuthVodafoneOAuth2Client(string clientId, string clientSecret, params string[] requestedScopes)
            : base("Vodafone")
        {
