...
namespace Laser.Orchard.UserReactions.FilterEditors {
    public class UserReactionsFieldFilterForm : IFormProvider {

        public const string FormName = "UserReactionsFieldFilter";
        ...
        public UserReactionsFieldFilterForm(IShapeFactory shapeFactory) {
                ...
                shape => {
                      ...
                      _Reaction: _shapeFactory.SelectList(
                                  ...
                                  // Classes: new[] { "text medium", "tokenized" }
                                   //Description: T("Reactions to filter")
                                   ),
                    ...
                    {
                        f._Reaction.Add(new SelectListItem { Value = item.Value.ToString(), Text = item.Key.ToString() });
                    }
