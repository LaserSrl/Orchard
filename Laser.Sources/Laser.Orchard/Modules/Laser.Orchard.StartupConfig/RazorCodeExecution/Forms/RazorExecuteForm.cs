            ...
            Func<IShapeFactory, dynamic> form =
              shape => Shape.Form(
                ...
                _RazorView: Shape.Textbox(
                  ...
                  Title: T("Razor View"),
                  Description: T("The razor view to run every time the Decision Activity is invoked. You can use Model.ContentItem, Model.T, Model.OrchardServices. The razor output (e.g. 'Success)' or 'Error' should be used to define the 'texthint' outcome of the activity."),
