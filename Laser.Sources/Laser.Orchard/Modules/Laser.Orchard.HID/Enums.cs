...
namespace Laser.Orchard.HID {
    ...
    public enum UserErrors { NoError = 0, UnknownError = 1, DoesNotExist = 2, AuthorizationFailed = 3, InternalServerError = 4,
        InvalidParameters = 5, EmailNotUnique = 6, PreconditionFailed = 7, DoesNotHaveDevices = 8 }
    public enum CredentialErrors { NoError = 0, UnknownError = 1, CredentialDeliveredAlready = 2 }
