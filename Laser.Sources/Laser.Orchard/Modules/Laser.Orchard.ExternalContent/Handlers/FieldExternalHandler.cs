                        ...
                        if (field.GetType().Name == "FieldExternal") {
                            ...
                            if (settings.NoFollow) {
                                ...
                                if (string.IsNullOrEmpty(settings.ExternalURL))
                                    field.ContentObject = _fieldExternalService.GetContentfromField(Myobject, field.ExternalUrl, field.Name, context.ContentItem.ContentType);
                                else
                                    field.ContentObject = _fieldExternalService.GetContentfromField(Myobject, settings.ExternalURL, field.Name, context.ContentItem.ContentType);
