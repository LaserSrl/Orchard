        ...
        public void Describe(DescribeContext context) {
            Func<IShapeFactory, dynamic> form =
                shape => {
                    ...
                    f._Type._ddlDevice.Add(new SelectListItem { Value = "UserEmail", Text = "User specified by email" });
                    f._Type._ddlDevice.Add(new SelectListItem { Value = "UserName", Text = "User specified by name" });
