::Batch file to deploy Orchard.Framework.dll
...
pushd ".."
	...
	SETLOCAL EnableDelayedExpansion
		for /d /r %%f in (*bin) do (
			if exist %%f\Orchard.Framework.dll (
				...
				@echo on
				xcopy %%f\Orchard.Framework.dll C:\Sviluppo\Laser.Platform.Orchard\Laser.Sources\Laser.Deploy\DeployScripts\Deploy!folder:~66!\ /S /Y 
				@echo off
			)
		)
