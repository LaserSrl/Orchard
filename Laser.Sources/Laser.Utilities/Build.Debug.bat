...
MSBuild /m /nologo /v:q /l:FileLogger,Microsoft.Build.Engine;logfile=%LaserPlatformOrchardFolder%\Laser.Sources\Laser.Utilities\Orchard.log %LaserPlatformOrchardFolder%\Orchard.Sources\src\Orchard.sln /t:Rebuild /p:Configuration="Debug" /p:Platform="Any CPU"
if %errorlevel% neq 0 ( 
